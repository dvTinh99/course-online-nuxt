            ...
            <div
                ...
                <div class="mx-auto text-center max-w-xl md:max-w-2xl relative">
                    <div class="mx-auto max-w-md sm:max-w-xl pt-10">
                        <form action="" class="items-center relative gap-x-2">
                            <input type="email" placeholder="johndoe@gmail.com"
                                class="outline-none border-2 border-transparent focus:border-primary bg-body text-gray-600 dark:text-gray-200 rounded-3xl px-6 py-3 w-full mb-5">
